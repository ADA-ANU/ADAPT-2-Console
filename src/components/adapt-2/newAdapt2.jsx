...
export default class newAdapt2 extends Component {
  ...
  componentDidMount() {
    this.props.adapt2Store.setSelection();
  }
    ...
    const submitCheck = () => {
      ...
      if (adapt2Store.selection !== 1) {
        if (adapt2Store.selection === 2) {
          ...
          if (
            [...systemStore.localSelectedKeys.values()].length === 0 &&
            [...systemStore.remoteSelectedKeys.values()].length === 0
          ) {
            return true;
                ...
                >
                  ...
                  <div style={radioStyle}>
                    <Row>
                      <Col>
                        <Radio value={3}>
                          Existing ADAID - select on existing ADAID and add
                          files
                        </Radio>
                      </Col>
                      <Col>
