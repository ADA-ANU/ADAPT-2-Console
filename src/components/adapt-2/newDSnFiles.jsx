...
export default class NewDSnFiles extends Component {
  ...
  openNotification = () => {
    notification.warning({
      ...
      description: (
        <div>
          <span>
            Following are the duplicates found on the ADA directory{" "}
            {this.state.selectedADAFolder}.
          </span>
          <ol>
  ...
  render() {
    ...
    //console.log(server)
    if (systemStore.duplicateFileList.length > 0) {
    ...
    const submitCheck = () => {
      if (
        systemStore.localTargetKeys.length === 0 &&
        systemStore.remoteTargetKeys.length === 0
      ) {
        return true;
      } else if (
          ...
          {adapt2Store.inputSource === 1 ? (
            <>
              ...
              </Form.Item>
              {
                // this.state.server?
                sourceServer ? (
                  <div style={{ marginLeft: "15vw", marginBottom: "1vh" }}>
                    <Tag
                      color="default"
                    ...
                    {doiServer ? (
                      <Tag
                        ...
                        color={
                          doiServer === "Server not found." ? "#f50" : "#87d068"
                        }
                      >
                        {doiServer}
                      </Tag>
